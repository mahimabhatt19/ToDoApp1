...
public class secondactivity extends AppCompatActivity implements View.OnClickListener,AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        itemET1=findViewById(R.id.item_edit_text1);
        btn1=findViewById(R.id.add_btn1);
        itemsList1=findViewById(R.id.items_list1);

        items1 = FileHelper1.readData( this);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.add_btn1:
                ...
                FileHelper1.writeData(items1,this);
